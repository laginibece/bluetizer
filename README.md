[![pub package](https://img.shields.io/pub/v/bluetizer.svg)](https://pub.dartlang.org/packages/bluetizer)

<br>
<p align="center">
<img alt="Bluetizer" src="https://github.com/laginibece/bluetizer/blob/master/site/bluetizer.png?raw=true" />
</p>
<br><br>

## Introduction

Bluetizer is a bluetooth plugin for [Flutter](http://www.flutter.io), a new mobile SDK to help developers build modern apps for iOS and Android.

## Cross-Platform Bluetooth LE
Bluetizer aims to offer the most from both platforms (iOS and Android).

Using the Bluetizer instance, you can scan for and connect to nearby devices ([BluetoothDevice](#bluetoothdevice-api)).
...
### Obtain an instance
```dart
Bluetizer bluetizer = Bluetizer.instance;
```

### Scan for devices
```dart
/// Start scanning
var scanSubscription = bluetizer.scan().listen((scanResult) {
...
var deviceConnection = bluetizer.connect(device).listen((s) {
