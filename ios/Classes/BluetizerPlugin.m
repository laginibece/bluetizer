#import "BluetizerPlugin.h"
#import "Bluetizer.pbobjc.h"

@interface CBUUID (CBUUIDAdditionsBluetizer)
- (NSString *)fullUUIDString;
@end

@implementation CBUUID (CBUUIDAdditionsBluetizer)
- (NSString *)fullUUIDString {
...
@interface BluetizerPlugin ()
@property(nonatomic, retain) NSObject<FlutterPluginRegistrar> *registrar;
@property(nonatomic, retain) FlutterMethodChannel *channel;
@property(nonatomic, retain) BluetizerStreamHandler *stateStreamHandler;
@property(nonatomic, retain) BluetizerStreamHandler *scanResultStreamHandler;
@property(nonatomic, retain) BluetizerStreamHandler *servicesDiscoveredStreamHandler;
@property(nonatomic, retain) BluetizerStreamHandler *characteristicReadStreamHandler;
@property(nonatomic, retain) BluetizerStreamHandler *descriptorReadStreamHandler;
...
@implementation BluetizerPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  ...
  BluetizerPlugin* instance = [[BluetizerPlugin alloc] init];
  ...
  // STATE
  BluetizerStreamHandler* stateStreamHandler = [[BluetizerStreamHandler alloc] init];
  [stateChannel setStreamHandler:stateStreamHandler];
  instance.stateStreamHandler = stateStreamHandler;
  
  // SCAN RESULTS
  BluetizerStreamHandler* scanResultStreamHandler = [[BluetizerStreamHandler alloc] init];
  [scanResultChannel setStreamHandler:scanResultStreamHandler];
  instance.scanResultStreamHandler = scanResultStreamHandler;
  
  // SERVICES DISCOVERED
  BluetizerStreamHandler* servicesDiscoveredStreamHandler = [[BluetizerStreamHandler alloc] init];
  ...
  // CHARACTERISTIC READ
  BluetizerStreamHandler* characteristicReadStreamHandler = [[BluetizerStreamHandler alloc] init];
  ...
  // DESCRIPTOR READ
  BluetizerStreamHandler* descriptorReadStreamHandler = [[BluetizerStreamHandler alloc] init];
...
@implementation BluetizerStreamHandler
