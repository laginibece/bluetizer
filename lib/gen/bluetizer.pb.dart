...
import 'bluetizer.pbenum.dart';

export 'bluetizer.pbenum.dart';
...
class BluetoothState extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BluetoothState')
    ..e<BluetoothState_State>(
        ...
        'state',
        PbFieldType.OE,
        BluetoothState_State.UNKNOWN,
        BluetoothState_State.valueOf,
        BluetoothState_State.values)
    ..hasRequiredFields = false;
  ...
  static PbList<BluetoothState> createRepeated() =>
      new PbList<BluetoothState>();
  static BluetoothState getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyBluetoothState();
    return _defaultInstance;
  }
...
class AdvertisementData_ManufacturerDataEntry extends GeneratedMessage {
  static final BuilderInfo _i =
      new BuilderInfo('AdvertisementData_ManufacturerDataEntry')
        ..a<int>(1, 'key', PbFieldType.O3)
        ..a<List<int>>(2, 'value', PbFieldType.OY)
        ..hasRequiredFields = false;

  AdvertisementData_ManufacturerDataEntry() : super();
  AdvertisementData_ManufacturerDataEntry.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  AdvertisementData_ManufacturerDataEntry.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  AdvertisementData_ManufacturerDataEntry clone() =>
      new AdvertisementData_ManufacturerDataEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AdvertisementData_ManufacturerDataEntry create() =>
      new AdvertisementData_ManufacturerDataEntry();
  static PbList<AdvertisementData_ManufacturerDataEntry> createRepeated() =>
      new PbList<AdvertisementData_ManufacturerDataEntry>();
  static AdvertisementData_ManufacturerDataEntry getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyAdvertisementData_ManufacturerDataEntry();
    return _defaultInstance;
  }
  ...
  static void $checkItem(AdvertisementData_ManufacturerDataEntry v) {
    if (v is! AdvertisementData_ManufacturerDataEntry)
      checkItemFailed(v, 'AdvertisementData_ManufacturerDataEntry');
  }
...
class _ReadonlyAdvertisementData_ManufacturerDataEntry
    extends AdvertisementData_ManufacturerDataEntry with ReadonlyMessageMixin {}

class AdvertisementData_ServiceDataEntry extends GeneratedMessage {
  static final BuilderInfo _i =
      new BuilderInfo('AdvertisementData_ServiceDataEntry')
        ..aOS(1, 'key')
        ..a<List<int>>(2, 'value', PbFieldType.OY)
        ..hasRequiredFields = false;

  AdvertisementData_ServiceDataEntry() : super();
  AdvertisementData_ServiceDataEntry.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  AdvertisementData_ServiceDataEntry.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  AdvertisementData_ServiceDataEntry clone() =>
      new AdvertisementData_ServiceDataEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AdvertisementData_ServiceDataEntry create() =>
      new AdvertisementData_ServiceDataEntry();
  static PbList<AdvertisementData_ServiceDataEntry> createRepeated() =>
      new PbList<AdvertisementData_ServiceDataEntry>();
  static AdvertisementData_ServiceDataEntry getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyAdvertisementData_ServiceDataEntry();
    return _defaultInstance;
  }

  static AdvertisementData_ServiceDataEntry _defaultInstance;
  static void $checkItem(AdvertisementData_ServiceDataEntry v) {
    if (v is! AdvertisementData_ServiceDataEntry)
      checkItemFailed(v, 'AdvertisementData_ServiceDataEntry');
  }
...
class _ReadonlyAdvertisementData_ServiceDataEntry
    extends AdvertisementData_ServiceDataEntry with ReadonlyMessageMixin {}

class AdvertisementData extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AdvertisementData')
    ..aOS(1, 'localName')
    ..a<Int32Value>(2, 'txPowerLevel', PbFieldType.OM, Int32Value.getDefault,
        Int32Value.create)
    ..aOB(3, 'connectable')
    ..pp<AdvertisementData_ManufacturerDataEntry>(
        4,
        'manufacturerData',
        PbFieldType.PM,
        AdvertisementData_ManufacturerDataEntry.$checkItem,
        AdvertisementData_ManufacturerDataEntry.create)
    ..pp<AdvertisementData_ServiceDataEntry>(
        5,
        'serviceData',
        PbFieldType.PM,
        AdvertisementData_ServiceDataEntry.$checkItem,
        AdvertisementData_ServiceDataEntry.create)
    ..pPS(6, 'serviceUuids')
    ..hasRequiredFields = false;
  ...
  static PbList<AdvertisementData> createRepeated() =>
      new PbList<AdvertisementData>();
  static AdvertisementData getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyAdvertisementData();
    return _defaultInstance;
  }
  ...
  List<AdvertisementData_ManufacturerDataEntry> get manufacturerData =>
      $_getList(3);
...
class _ReadonlyAdvertisementData extends AdvertisementData
...
class ScanSettings extends GeneratedMessage {
  ...
  static ScanSettings getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyScanSettings();
    return _defaultInstance;
  }
...
class ScanResult extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ScanResult')
    ..a<BluetoothDevice>(1, 'device', PbFieldType.OM,
        BluetoothDevice.getDefault, BluetoothDevice.create)
    ..a<AdvertisementData>(2, 'advertisementData', PbFieldType.OM,
        AdvertisementData.getDefault, AdvertisementData.create)
  ...
  ScanResult.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ScanResult.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class BluetoothDevice extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BluetoothDevice')
    ...
    ..e<BluetoothDevice_Type>(
        ...
        'type',
        PbFieldType.OE,
        BluetoothDevice_Type.UNKNOWN,
        BluetoothDevice_Type.valueOf,
        BluetoothDevice_Type.values)
    ..hasRequiredFields = false;
  ...
  static PbList<BluetoothDevice> createRepeated() =>
      new PbList<BluetoothDevice>();
  static BluetoothDevice getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyBluetoothDevice();
    return _defaultInstance;
  }
...
class _ReadonlyBluetoothDevice extends BluetoothDevice
    with ReadonlyMessageMixin {}
...
class BluetoothService extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BluetoothService')
    ...
    ..aOS(2, 'remoteId')
    ..aOB(3, 'isPrimary')
    ..pp<BluetoothCharacteristic>(4, 'characteristics', PbFieldType.PM,
        BluetoothCharacteristic.$checkItem, BluetoothCharacteristic.create)
    ..pp<BluetoothService>(5, 'includedServices', PbFieldType.PM,
        BluetoothService.$checkItem, BluetoothService.create)
    ..hasRequiredFields = false;
  ...
  static PbList<BluetoothService> createRepeated() =>
      new PbList<BluetoothService>();
  static BluetoothService getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyBluetoothService();
    return _defaultInstance;
  }
...
class _ReadonlyBluetoothService extends BluetoothService
    with ReadonlyMessageMixin {}
...
class BluetoothCharacteristic extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BluetoothCharacteristic')
    ...
    ..pp<BluetoothDescriptor>(4, 'descriptors', PbFieldType.PM,
        BluetoothDescriptor.$checkItem, BluetoothDescriptor.create)
    ..a<CharacteristicProperties>(5, 'properties', PbFieldType.OM,
        CharacteristicProperties.getDefault, CharacteristicProperties.create)
  ...
  static PbList<BluetoothCharacteristic> createRepeated() =>
      new PbList<BluetoothCharacteristic>();
  static BluetoothCharacteristic getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyBluetoothCharacteristic();
    return _defaultInstance;
  }

  static BluetoothCharacteristic _defaultInstance;
  static void $checkItem(BluetoothCharacteristic v) {
    if (v is! BluetoothCharacteristic)
      checkItemFailed(v, 'BluetoothCharacteristic');
  }
...
class _ReadonlyBluetoothCharacteristic extends BluetoothCharacteristic
    with ReadonlyMessageMixin {}
...
class BluetoothDescriptor extends GeneratedMessage {
  ...
  static PbList<BluetoothDescriptor> createRepeated() =>
      new PbList<BluetoothDescriptor>();
  static BluetoothDescriptor getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyBluetoothDescriptor();
    return _defaultInstance;
  }
  ...
  set characteristicUuid(String v) {
    $_setString(2, v);
  }
...
class _ReadonlyBluetoothDescriptor extends BluetoothDescriptor
    with ReadonlyMessageMixin {}
...
class CharacteristicProperties extends GeneratedMessage {
  ...
  static PbList<CharacteristicProperties> createRepeated() =>
      new PbList<CharacteristicProperties>();
  static CharacteristicProperties getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyCharacteristicProperties();
    return _defaultInstance;
  }

  static CharacteristicProperties _defaultInstance;
  static void $checkItem(CharacteristicProperties v) {
    if (v is! CharacteristicProperties)
      checkItemFailed(v, 'CharacteristicProperties');
  }
...
class DiscoverServicesResult extends GeneratedMessage {
  ...
  static PbList<DiscoverServicesResult> createRepeated() =>
      new PbList<DiscoverServicesResult>();
  static DiscoverServicesResult getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyDiscoverServicesResult();
    return _defaultInstance;
  }

  static DiscoverServicesResult _defaultInstance;
  static void $checkItem(DiscoverServicesResult v) {
    if (v is! DiscoverServicesResult)
      checkItemFailed(v, 'DiscoverServicesResult');
  }
...
class _ReadonlyDiscoverServicesResult extends DiscoverServicesResult
    with ReadonlyMessageMixin {}
...
class ReadCharacteristicRequest extends GeneratedMessage {
  ...
  static PbList<ReadCharacteristicRequest> createRepeated() =>
      new PbList<ReadCharacteristicRequest>();
  static ReadCharacteristicRequest getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyReadCharacteristicRequest();
    return _defaultInstance;
  }

  static ReadCharacteristicRequest _defaultInstance;
  static void $checkItem(ReadCharacteristicRequest v) {
    if (v is! ReadCharacteristicRequest)
      checkItemFailed(v, 'ReadCharacteristicRequest');
  }
...
class _ReadonlyReadCharacteristicRequest extends ReadCharacteristicRequest
    with ReadonlyMessageMixin {}
...
class ReadCharacteristicResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ReadCharacteristicResponse')
    ..aOS(1, 'remoteId')
    ..a<BluetoothCharacteristic>(2, 'characteristic', PbFieldType.OM,
        BluetoothCharacteristic.getDefault, BluetoothCharacteristic.create)
    ..hasRequiredFields = false;
  ...
  static PbList<ReadCharacteristicResponse> createRepeated() =>
      new PbList<ReadCharacteristicResponse>();
  static ReadCharacteristicResponse getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyReadCharacteristicResponse();
    return _defaultInstance;
  }

  static ReadCharacteristicResponse _defaultInstance;
  static void $checkItem(ReadCharacteristicResponse v) {
    if (v is! ReadCharacteristicResponse)
      checkItemFailed(v, 'ReadCharacteristicResponse');
  }
...
class _ReadonlyReadCharacteristicResponse extends ReadCharacteristicResponse
    with ReadonlyMessageMixin {}
...
class ReadDescriptorRequest extends GeneratedMessage {
  ...
  static PbList<ReadDescriptorRequest> createRepeated() =>
      new PbList<ReadDescriptorRequest>();
  static ReadDescriptorRequest getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyReadDescriptorRequest();
    return _defaultInstance;
  }

  static ReadDescriptorRequest _defaultInstance;
  static void $checkItem(ReadDescriptorRequest v) {
    if (v is! ReadDescriptorRequest)
      checkItemFailed(v, 'ReadDescriptorRequest');
  }
...
class _ReadonlyReadDescriptorRequest extends ReadDescriptorRequest
    with ReadonlyMessageMixin {}

class ReadDescriptorResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ReadDescriptorResponse')
    ..a<ReadDescriptorRequest>(1, 'request', PbFieldType.OM,
        ReadDescriptorRequest.getDefault, ReadDescriptorRequest.create)
    ..a<List<int>>(2, 'value', PbFieldType.OY)
    ..hasRequiredFields = false;
  ...
  static PbList<ReadDescriptorResponse> createRepeated() =>
      new PbList<ReadDescriptorResponse>();
  static ReadDescriptorResponse getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyReadDescriptorResponse();
    return _defaultInstance;
  }

  static ReadDescriptorResponse _defaultInstance;
  static void $checkItem(ReadDescriptorResponse v) {
    if (v is! ReadDescriptorResponse)
      checkItemFailed(v, 'ReadDescriptorResponse');
  }
...
class _ReadonlyReadDescriptorResponse extends ReadDescriptorResponse
    with ReadonlyMessageMixin {}
...
class WriteCharacteristicRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('WriteCharacteristicRequest')
    ...
    ..e<WriteCharacteristicRequest_WriteType>(
        ...
        'writeType',
        PbFieldType.OE,
        WriteCharacteristicRequest_WriteType.WITH_RESPONSE,
        WriteCharacteristicRequest_WriteType.valueOf,
        WriteCharacteristicRequest_WriteType.values)
    ..a<List<int>>(6, 'value', PbFieldType.OY)
    ..hasRequiredFields = false;
  ...
  static PbList<WriteCharacteristicRequest> createRepeated() =>
      new PbList<WriteCharacteristicRequest>();
  static WriteCharacteristicRequest getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyWriteCharacteristicRequest();
    return _defaultInstance;
  }

  static WriteCharacteristicRequest _defaultInstance;
  static void $checkItem(WriteCharacteristicRequest v) {
    if (v is! WriteCharacteristicRequest)
      checkItemFailed(v, 'WriteCharacteristicRequest');
  }
...
class _ReadonlyWriteCharacteristicRequest extends WriteCharacteristicRequest
    with ReadonlyMessageMixin {}
...
class WriteCharacteristicResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('WriteCharacteristicResponse')
    ..a<WriteCharacteristicRequest>(
        1,
        'request',
        PbFieldType.OM,
        WriteCharacteristicRequest.getDefault,
        WriteCharacteristicRequest.create)
    ..aOB(2, 'success')
    ..hasRequiredFields = false;
  ...
  static PbList<WriteCharacteristicResponse> createRepeated() =>
      new PbList<WriteCharacteristicResponse>();
  static WriteCharacteristicResponse getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyWriteCharacteristicResponse();
    return _defaultInstance;
  }

  static WriteCharacteristicResponse _defaultInstance;
  static void $checkItem(WriteCharacteristicResponse v) {
    if (v is! WriteCharacteristicResponse)
      checkItemFailed(v, 'WriteCharacteristicResponse');
  }
...
class _ReadonlyWriteCharacteristicResponse extends WriteCharacteristicResponse
    with ReadonlyMessageMixin {}
...
class WriteDescriptorRequest extends GeneratedMessage {
  ...
  static PbList<WriteDescriptorRequest> createRepeated() =>
      new PbList<WriteDescriptorRequest>();
  static WriteDescriptorRequest getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyWriteDescriptorRequest();
    return _defaultInstance;
  }

  static WriteDescriptorRequest _defaultInstance;
  static void $checkItem(WriteDescriptorRequest v) {
    if (v is! WriteDescriptorRequest)
      checkItemFailed(v, 'WriteDescriptorRequest');
  }
...
class _ReadonlyWriteDescriptorRequest extends WriteDescriptorRequest
    with ReadonlyMessageMixin {}
...
class WriteDescriptorResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('WriteDescriptorResponse')
    ..a<WriteDescriptorRequest>(1, 'request', PbFieldType.OM,
        WriteDescriptorRequest.getDefault, WriteDescriptorRequest.create)
    ..aOB(2, 'success')
    ..hasRequiredFields = false;
  ...
  static PbList<WriteDescriptorResponse> createRepeated() =>
      new PbList<WriteDescriptorResponse>();
  static WriteDescriptorResponse getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyWriteDescriptorResponse();
    return _defaultInstance;
  }

  static WriteDescriptorResponse _defaultInstance;
  static void $checkItem(WriteDescriptorResponse v) {
    if (v is! WriteDescriptorResponse)
      checkItemFailed(v, 'WriteDescriptorResponse');
  }
...
class _ReadonlyWriteDescriptorResponse extends WriteDescriptorResponse
    with ReadonlyMessageMixin {}
...
class SetNotificationRequest extends GeneratedMessage {
  ...
  static PbList<SetNotificationRequest> createRepeated() =>
      new PbList<SetNotificationRequest>();
  static SetNotificationRequest getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlySetNotificationRequest();
    return _defaultInstance;
  }

  static SetNotificationRequest _defaultInstance;
  static void $checkItem(SetNotificationRequest v) {
    if (v is! SetNotificationRequest)
      checkItemFailed(v, 'SetNotificationRequest');
  }
...
class _ReadonlySetNotificationRequest extends SetNotificationRequest
    with ReadonlyMessageMixin {}
...
class SetNotificationResponse extends GeneratedMessage {
  ...
  static PbList<SetNotificationResponse> createRepeated() =>
      new PbList<SetNotificationResponse>();
  static SetNotificationResponse getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlySetNotificationResponse();
    return _defaultInstance;
  }

  static SetNotificationResponse _defaultInstance;
  static void $checkItem(SetNotificationResponse v) {
    if (v is! SetNotificationResponse)
      checkItemFailed(v, 'SetNotificationResponse');
  }
...
class _ReadonlySetNotificationResponse extends SetNotificationResponse
    with ReadonlyMessageMixin {}
...
class OnNotificationResponse extends GeneratedMessage {
  ...
  static PbList<OnNotificationResponse> createRepeated() =>
      new PbList<OnNotificationResponse>();
  static OnNotificationResponse getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyOnNotificationResponse();
    return _defaultInstance;
  }

  static OnNotificationResponse _defaultInstance;
  static void $checkItem(OnNotificationResponse v) {
    if (v is! OnNotificationResponse)
      checkItemFailed(v, 'OnNotificationResponse');
  }
...
class _ReadonlyOnNotificationResponse extends OnNotificationResponse
    with ReadonlyMessageMixin {}
...
class DeviceStateResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DeviceStateResponse')
    ...
    ..e<DeviceStateResponse_BluetoothDeviceState>(
        ...
        'state',
        PbFieldType.OE,
        DeviceStateResponse_BluetoothDeviceState.DISCONNECTED,
        DeviceStateResponse_BluetoothDeviceState.valueOf,
        DeviceStateResponse_BluetoothDeviceState.values)
    ..hasRequiredFields = false;
  ...
  static PbList<DeviceStateResponse> createRepeated() =>
      new PbList<DeviceStateResponse>();
  static DeviceStateResponse getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyDeviceStateResponse();
    return _defaultInstance;
  }
...
class _ReadonlyDeviceStateResponse extends DeviceStateResponse
    with ReadonlyMessageMixin {}
