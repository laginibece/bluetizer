...
class BluetoothDevice {
  ...
  Future<List<BluetoothService>> discoverServices() async {
    await Bluetizer.instance._channel
        .invokeMethod('discoverServices', id.toString());

    return await Bluetizer.instance._servicesDiscoveredChannel
  ...
  Future<List<BluetoothService>> get services {
    return Bluetizer.instance._channel
  ...
  Future<List<int>> readCharacteristic(
    ...
    return await Bluetizer.instance._characteristicReadChannel
        .receiveBroadcastStream()
        .map((buffer) =>
  ...
  Future<List<int>> readDescriptor(BluetoothDescriptor descriptor) async {
    ...
    return await Bluetizer.instance._descriptorReadChannel
        .receiveBroadcastStream()
  ...
  Future<Null> writeCharacteristic(
    ...
    var result = await Bluetizer.instance._channel
    ...
    return await Bluetizer.instance._methodStream
  ...
  Stream<List<int>> onValueChanged(BluetoothCharacteristic characteristic) {
    return Bluetizer.instance._methodStream
  ...
  Future<BluetoothDeviceState> get state => Bluetizer.instance._channel
