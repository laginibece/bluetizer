...
package rsvhr.laginibece.bluetizer;
 ...
 * BluetizerPlugin
 */
public class BluetizerPlugin implements MethodCallHandler, RequestPermissionsResultListener  {
    private static final String TAG = "BluetizerPlugin";
    private static final String NAMESPACE = "plugins..com/bluetizer";
    ...
    public static void registerWith(Registrar registrar) {
        final BluetizerPlugin instance = new BluetizerPlugin(registrar);
        registrar.addRequestPermissionsResultListener(instance);
    }

    BluetizerPlugin(Registrar r){
        this.registrar = r;
    ...
    public boolean onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_COARSE_LOCATION_PERMISSIONS) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                pendingResult.error(
                        "no_permissions", "bluetizer plugin requires location permissions for scanning", null);
                pendingResult = null;
                pendingCall = null;
            }
            return true;
